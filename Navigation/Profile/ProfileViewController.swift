...
final class ProfileViewController: UIViewController {
    ...
    override func viewWillLayoutSubviews() {
        ...
        let topConstraint = self.profileHeader.topAnchor.constraint(equalTo: self.view.topAnchor, constant: 90)
        ...
        let bottomConstraint = self.profileHeader.bottomAnchor.constraint(equalTo: self.view.bottomAnchor, constant: -90)
